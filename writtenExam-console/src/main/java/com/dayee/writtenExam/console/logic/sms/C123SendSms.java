package com.dayee.writtenExam.console.logic.sms;

import com.dayee.writtenExam.console.model.config.WrittenExamConfig;
import com.dayee.writtenExam.console.model.constants.Constants;
import com.dayee.writtenExam.console.model.sms.SmsConfig;
...
public class C123SendSms {
    ...
    /*
     * static { //FIXME 配置文件中读取 String c123Account = "1001@500774980001"; String
     * interfaceKey = "61C5B5D91AED57FB21047EA31299E2C5"; String c123Url =
     * "http://smsapi.c123.cn/OpenPlatform/OpenApi"; String channelGroup =
     * "1215"; systemSmsConfig = new SmsConfig();
     * systemSmsConfig.setC123Account(c123Account);
     * systemSmsConfig.setInterfaceKey(interfaceKey);
     * systemSmsConfig.setC123Url(c123Url);
     * systemSmsConfig.setChannelGroup(channelGroup); }
     */

    public static SmsConfig getMessageConfigInfo() {

        systemSmsConfig = new SmsConfig();
        systemSmsConfig.setC123Account(WrittenExamConfig.getC123Account());
        systemSmsConfig.setInterfaceKey(WrittenExamConfig.getInterfaceKey());
        systemSmsConfig.setC123Url(WrittenExamConfig.getC123Url());
        systemSmsConfig.setChannelGroup(WrittenExamConfig.getChannelGroup());
    ...
    public static void main(String[] args) throws Exception {
        ...
        String result = send(null, "18612180483", "测试HRSAAS SMS");
